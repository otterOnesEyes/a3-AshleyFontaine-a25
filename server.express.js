...
const constructLeaderboard = async (req, res, next) => {
  try{
    if(req.url != "/login"){
      ...
      // Table header line
      lb = `<h3 style="font-family: 'Knewave', system-ui; margin-left: 100%">Leaderboard</h3><tr id=lbhead><th>Rank</th><th>Player</th><th>Score</th><th>Grade</th><th>Combo</th><th>Complete</th></tr>`
